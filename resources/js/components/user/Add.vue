            ...
            <div class="row">
              ...
              <div class="col-12 mb-2">
                <div class="form-group">
                  ...
                  />
                  <div
                    v-if="user.errors.has('password_confirm')"
                    v-html="user.errors.get('password_confirm')"
                    class="text-danger"
                  />
                </div>
              </div>
              <div class="col-12 mb-2">
                <div class="form-group">
                  ...
                  <div
                    v-if="user.errors.has('type')"
                    v-html="user.errors.get('type')"
                    class="text-danger"
                  />
                </div>
              </div>
              ...
              <div class="col-12 mb-2">
                <div class="form-group">
                  ...
                  />
                  <div
                    v-if="user.errors.has('profile')"
                    v-html="user.errors.get('profile')"
                    class="text-danger"
                  />
                </div>
              </div>
